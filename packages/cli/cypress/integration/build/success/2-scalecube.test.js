...
describe('Capsulahub build TCs #2 success (Scalecube)', () => {
  it('Build CapsulaHub instance with specifying valid arguments (check for ScalecubeConfigurationProvider)', () => {
